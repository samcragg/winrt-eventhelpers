namespace EventHelpers
{
    ...
    /// <summary>
    /// Allows the binding of a command to the QuerySubmitted event on a SearchBox.
    /// </summary>
    public sealed class SearchBoxQuerySubmitted : EventCommandAdapter<SearchBoxQuerySubmitted>
    {
        /// <summary>
        ...
        {
            ((SearchBox)source).QuerySubmitted += this.OnSearchBoxQuerySubmitted;
        }
